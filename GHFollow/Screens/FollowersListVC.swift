...
//  GHFollow
//
//  Created by Doğukan Varılmaz on 26.03.2023.
//
...
class FollowerListVC: GFDataLoadingVC {
    ...
    func configureCollectionView() {
        collectionView = UICollectionView(frame: view.bounds, collectionViewLayout: UIHelper.createThereeColumnFlowlayout(in: view))
